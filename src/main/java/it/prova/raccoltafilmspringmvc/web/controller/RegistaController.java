...
public class RegistaController {
	...
	public String editRegista(@PathVariable(required = true) Long idRegista, Model model) {
		model.addAttribute("edit_regista_attr",
				RegistaDTO.buildRegistaDTOFromModel(registaService.caricaSingoloElementoConFilms(idRegista)));
		return "regista/edit";
	}
	...
	public String showDelete(@PathVariable(required = true) Long idRegista, Model model) {
	...
	public String Delete(@RequestParam Long idRegista
			,RedirectAttributes redirectAttrs) {
