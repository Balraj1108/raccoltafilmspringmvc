...
public class FilmController {
	...
	public String editFilm(@PathVariable(required = true) Long idFilm, Model model) {
		model.addAttribute("insert_film_attr",
	...
	public String updateFilm(@Valid @ModelAttribute("insert_film_attr") FilmDTO filmDTO, BindingResult result,
			RedirectAttributes redirectAttrs, HttpServletRequest request) {
	...
	public String showDelete(@PathVariable(required = true) Long idFilm, Model model) {
	...
	public String Delete(@RequestParam Long idFilm
